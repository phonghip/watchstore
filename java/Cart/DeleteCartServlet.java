...
public class DeleteCartServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        String aid_raw=request.getParameter("aid");int aid=0;
        String pid_raw=request.getParameter("pid");int pid=0;
        try {
        ...
        out.print(d.deleteFromCart(aid, pid_raw));
        request.getRequestDispatcher("cartUpload").forward(request, response);
    } 
