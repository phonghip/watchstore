...
public class RatingServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String rating_raw=request.getParameter("rating");int rating=0;
        ...
        out.println(rating+" "+c);
        if(dc.addInfomationToRatingsTable(aid, pid, rating,c)==0){
            request.setAttribute("error", "you already rated ");
        }      
        request.getRequestDispatcher("products?id="+pid+"&page=1").forward(request, response);
    } 
