 ...
 * @author khiem
 */
@WebServlet(name="ImgUserServlet", urlPatterns={"/imguser"})
@MultipartConfig
public class ImgUserServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ImgUserServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ImgUserServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("add")!=null){
            ...
            String add=request.getParameter("add");int aid=0;
            try {
            ...
            //update image          
            String add=request.getParameter("update");int aid=0;
            try {
                aid=Integer.parseInt(add);
            } catch (Exception e) {
            }
